# Angular Lab Projects 

This repository contains a collection of Angular application labs developed as part of the 2nd-semester Web Assignments. Each directory represents a separate project focused on specific Angular concepts, from basic data binding to complex state management.

## Project Structure

The repository is organized into several standalone Angular projects:
...
- **[TypeScript](https://www.typescriptlang.org/)** - Programming language for application logic.
- **[HTML5 / Vanilla CSS](https://developer.mozilla.org/en-US/docs/Web/CSS)** - For structure and styling.
...
- Master Angular Component Architecture.
- Implement Data Binding (One-way, Two-way, and Signals).
- Utilize Angular Directives (`@if`, `@for`).
- Manage application state and user input effectively.
